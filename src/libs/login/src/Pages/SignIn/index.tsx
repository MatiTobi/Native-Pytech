...
export default memo(({
    title='Apple',
    subtitle,
    iconPage=<Screen.SvgLogoPytech size={40} />
        ...
        fields: {
            ...
            confirmPassword: {
                ...
                error: ((): string | null => {
                    ...
                    if (confirmPassword !== newPassword && confirmPassword !== null) return 'Las contraseñas que ingresaste no coinciden'
                    return null
                }) as unknown as string | null,
            },
        },
        ...
        <>
            <Page style={{ paddingHorizontal: 40, marginTop: 34, paddingBottom: 200 }}>
                <View style={styles.viewTitle}>
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center', gap: 1 }}>
                        ...
                        <Link
                            text='Inicia sesión'
                            onPress={({ router }) => router.replace('/login/inicio')}
                            renderItems={({pressed}) =>
                                <Ionicons
            ...
            <Footer backgroundColorPage={Theme.backgroundColorModal2}>
                <Footer.Button
                    ...
                    backgroundColorPage={Theme.backgroundColorModal2} 
                    onPress={async () => {

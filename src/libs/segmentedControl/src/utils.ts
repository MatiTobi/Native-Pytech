...
export const scrollToIndex = ({
    ...
    if (blockEnd > visibleEnd)  target = blockEnd - containerWidth  // Si el bloque se sale por la derecha
    else if (blockStart < visibleStart) target = blockStart         // Si el bloque se sale por la izquierda
    else return                                                     // Si ya está todo visible, no hace nada

...
export default memo(({
	...
	return <Table.Option.Components.TextInput
        onChangeText={onValueChange}
        value={defaultValue}
        placeholderTextColor={Colors[colorScheme].SearchBarText}
        placeholder={placeholder ?? defaultValue}
        keyboardType={keyboardType}
        autoFocus={isUniqueItem}
        autoCapitalize={!autocapitalization ? 'none' : undefined}
        secureTextEntry={secureTextEntry}
        onSubmitEditing={() => _onSubmit(keyRef.current)}
    />
})
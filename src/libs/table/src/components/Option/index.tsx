...
import { Pressable, StyleSheet, View, StyleProp, ViewStyle, Platform } from 'react-native'
...
const AddTextView = memo(({ children, hasTextView }: { children: React.ReactNode, hasTextView?: boolean }) => {

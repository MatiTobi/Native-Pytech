...
import Colors, { ColorSchemeType } from "native-pytech/constants/colors"
...
export default memo(({
    ...
    return (
        <View style={[styles.container, { gap: spacing }]}>
            ...
            {buttonProps && (
                <Pressable onPress={buttonProps.onPress} style={styles.pressable}>
...
const Title = memo(({ title, colorScheme }: { title?: string, colorScheme: ColorSchemeType }) => {
    return (

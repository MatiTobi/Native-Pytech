...
export default memo(({
    ...
    return (
        <View style={[styles.view, { height: typeSizes.diameter, borderRadius: typeSizes.diameter }]}>
            <LinearGradient
                style={[styles.view, styles.gradient, { height: typeSizes.diameter, borderRadius: typeSizes.diameter }]}

...
exports.default = (0, react_1.memo)(({ ...props }) => {
    return (<TextInput_1.default keyboardType='numeric' autoCapitalize='none' autoCorrect={false} placeholder={'$0'} mask={(value) => value ? formatPeso(value) : formatPeso(0)} {...props}/>);
});
